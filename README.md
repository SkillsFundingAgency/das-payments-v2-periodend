# Payments V2 Period End

<img src="https://avatars.githubusercontent.com/u/9841374?s=200&v=4" align="right" alt="UK Government logo">

[![Build Status](https://dev.azure.com/sfa-gov-uk/DCT/_apis/build/status/GitHub/Service%20Fabric/SkillsFundingAgency.das-payments-v2-periodend?branchName=main)](https://dev.azure.com/sfa-gov-uk/DCT/_apis/build/status/GitHub/Service%20Fabric/SkillsFundingAgency.das-payments-v2-periodend?branchName=main)
...
The Payments V2 Period End service is responsible for the following steps: https://skillsfundingagency.atlassian.net/wiki/spaces/NDL/pages/1928527916/Automated+Period+End+Processing+Steps#Overview

More information here: 
- https://skillsfundingagency.atlassian.net/wiki/spaces/NDL/pages/400130049/4.+Payments+v2+-+Components+DAS+Space
- https://skillsfundingagency.atlassian.net/wiki/spaces/NDL/pages/3853058049/9.+Automated+Period+End+Processing+DAS+Space
## 🚀 Installation
...
Select the configuration for the Period End application
